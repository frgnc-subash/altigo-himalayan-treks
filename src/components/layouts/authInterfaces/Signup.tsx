  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-black font-sans py-10 px-4">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/src/assets/backgrounds/signup.jpg"
      ...
      <div className="relative z-10 w-full max-w-md p-6 md:p-8 bg-white/70 backdrop-blur-md border border-white/40 shadow-2xl shadow-black/20 rounded-3xl animate-fade-in-up">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-black text-gray-900 mb-1">Join the Tribe</h1>
        ...
        <div className="relative mb-5">
          ...
          <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-wider">
            <span className="bg-transparent px-2 text-gray-500">Or via email</span>
          </div>
        </div>
        ...
        <form className="space-y-3">
          ...
          <div className="flex items-start gap-3 mt-1 ml-1">
            ...
            />
            <label htmlFor="terms" className="text-xs text-gray-600 font-medium cursor-pointer leading-tight">
        ...
        <p className="mt-6 text-center text-sm text-gray-600 font-medium">
          ...
          <Link to="/login" className="font-bold text-[#084EA8] hover:underline">
            Log in
          </Link>
        </p>
      </div>
