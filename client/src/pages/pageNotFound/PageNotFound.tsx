...
const PageNotFound = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#050505] flex flex-col items-center justify-center px-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-secondary/10 blur-[150px] rounded-full z-0" />
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl">
        ...
        <div className="-mt-8 md:-mt-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/"
              className="w-full sm:w-auto px-8 py-4 bg-secondary text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all hover:bg-[#c0252c] active:scale-95 shadow-[0_0_20px_rgba(224,43,52,0.3)]"
            >
              <FaHome size={18} />
