...
const StaticLeftContent = memo(() => (
  <div className="space-y-10 animate-fade-in-up">
    <div>
      <span className="inline-block py-1 px-3 rounded-full bg-primary/20 border border-primary/50 text-[#3b82f6] text-[10px] font-bold uppercase tracking-widest mb-4">
        24/7 Support
      </span>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm font-medium rounded-lg px-4 py-3 focus:outline-none focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider ml-1">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm font-medium rounded-lg px-4 py-3 appearance-none focus:outline-none focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all cursor-pointer"
              >
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm font-medium rounded-lg px-4 py-3 focus:outline-none focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all resize-none"
            ></textarea>
          </div>
          ...
          <button
            ...
            className="w-full bg-black text-white font-bold py-3.5 rounded-xl hover:bg-primary hover:-translate-y-0.5 shadow-lg transition-all duration-200 flex items-center justify-center gap-2"
          >
